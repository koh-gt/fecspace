...
export class GroupPreviewComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.seoService.setDescription(`See all Lightning nodes run by Litecoin Foundation -- these are the nodes that provide the data on the litecoinspace.org Lightning dashboard.`);

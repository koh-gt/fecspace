...
init();`;
  ...
  wrapCommonJS(code: any) {
    ...
    if (code.codeTemplate) {
      ...
      const importText = `<script src="https://ferritecoin.com/mempool.js"></script>`;
...
yarn add @mempool/mempool.js`;
  ...
  wrapPythonTemplate(code: any) {
    return ( ( this.network === 'testnet' ) ? ( code.codeTemplate.python.replace( 'wss://ferritecoin.com/api/v1/ws', 'wss://ferritecoin.com/' + this.network + '/api/v1/ws' ) ) : code.codeTemplate.python );
  }

...
__CORE_RPC_PORT__=${CORE_RPC_PORT:=9573}
__CORE_RPC_USERNAME__=${CORE_RPC_USERNAME:=user}
__CORE_RPC_PASSWORD__=${CORE_RPC_PASSWORD:=password}
__CORE_RPC_TIMEOUT__=${CORE_RPC_TIMEOUT:=60000}

# ELECTRUM
__ELECTRUM_HOST__=${ELECTRUM_HOST:=127.0.0.1}
__ELECTRUM_PORT__=${ELECTRUM_PORT:=50011}
